#!/bin/bash
#
# Revised by Fred Weinhaus ...................... revised 4/2/2014
...
# [-p prune] [-u unrotate] [-m mask] infile outfile
...
#                            morphology octagon shape of the specified size; 
...
# morphologic octagon shape operations of the specified prune size. Values are 
...
if [ "$prune" != "" ]; then
	...
	pruneproc="-channel rgba -morphology open octagon:$prune"
else
	pruneproc=""
fi
